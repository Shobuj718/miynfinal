    ...
    public function allPosts(Request $request)
    {
        ...
        if(!empty($posts))
        {
            foreach ($posts as $post)
            {
                ...
                $nestedData['options'] = "<a href='{$show}' class='btn btn-sm btn-info ' pagename='Single package details' data-remote='false' data-toggle='modal' data-target='.modal' >show</a>
                        <a href='{$edit}' class='btn btn-sm btn-warning ' pagename='Single package edit' data-remote='false' data-toggle='modal' data-target='.modal'>edit</a>";
                $data[] = $nestedData;
