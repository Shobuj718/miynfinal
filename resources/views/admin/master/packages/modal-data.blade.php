...
<form id="formID" class="form-horizontal formular form-label-left" action="javascript:void(0)">
	...
	<fieldset>
		...
		<textarea class="form-control" name="package_description" id="package_description" placeholder="Enter package description" required></textarea>
	...
	<div class="modal-footer">
	    ...
	    <button type="submit" onclick="packageDataSubmit()" class="btn btn-primary waves-effect waves-light ">Save</button>
	</div>
</form>
</div>
