...
@section('business-category', 'active')
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <span style="float: right;">
            	...
            	<a href="{{ route('add.business.category') }}" pageName="Add New Currency" data-remote="false" data-toggle="modal" data-target=".modal" class="btn btn-sm btn-primary waves-effect md-trigger"> Add New </a>
        ...
        <div class="card-block">
        	...
        	<div class="">
                <table id="business-category" class="display compact nowrap table-bordered" style="width:100%">
                    <thead>
                        <tr>
                           <th>Id</th>
...
<script>
    $(document).ready(function () {
        $('#business-category').DataTable({
            "processing": true,
            'responsive': true,
            "serverSide": true,
            "orderClasses": false,
            "ajax":{
                     "url": "{{ url('all-business-category-show') }}",
                     "dataType": "json",
                     "type": "POST",
