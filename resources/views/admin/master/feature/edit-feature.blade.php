...
<form id="formID" class="form-horizontal formular form-label-left" action="javascript:void(0)">
	<fieldset>
		...
		<input type="text" class="form-control" name="feature_name" id="feature_name" value="{{ $feature->feature_name }}" placeholder="Enter feature name" required >

		<input type="hidden" class="form-control" name="id" id="id" value="{{ $feature->id }}" placeholder="Enter feature name" required >
	...
	<div class="modal-footer">
	    ...
	    <button type="submit" onclick="editFeature()" class="btn btn-primary waves-effect waves-light ">Save</button>
	</div>
</form>
</div>
