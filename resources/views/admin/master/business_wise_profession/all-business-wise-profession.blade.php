...
<div class="page-body">
    ...
    <div class="card">
        ...
        <div class="card-block">
        	...
        	<div class="">
                <table id="business-wise-profession" class="display compact nowrap table-bordered" style="width:100%">
                    <thead>
                        <tr>
                           <th width="50">Id</th>
...
<script>
    $(document).ready(function () {
        $('#business-wise-profession').DataTable({
            "processing": true,
            'responsive': true,
            "serverSide": true,
            "orderClasses": false,
            "ajax":{
                     "url": "{{ url('all-business-wise-professin-show') }}",
                     "dataType": "json",
                     "type": "POST",
