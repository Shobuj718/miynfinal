...
<form id="formID" class="form-horizontal formular form-label-left" action="javascript:void(0)">
	<fieldset>
		...
		<input type="text" class="form-control" name="language_name" id="language_name"  value="{{ $language->language_name }}" placeholder="Enter language name" required >

		<input type="hidden" class="form-control" name="id" id="id"  value="{{ $language->id }}" placeholder="Enter language name" required >
	...
	<fieldset>
		...
		<input type="text" class="form-control" name="short_name" id="short_name" value="{{ $language->short_name }}" placeholder="Enter short code name" required >
	...
	<div class="modal-footer">
	    ...
	    <button type="submit" onclick="editLanguage()" class="btn btn-primary waves-effect waves-light ">Save</button>
	</div>
</form>
</div>
